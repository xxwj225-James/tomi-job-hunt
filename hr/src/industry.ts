/**
 * Industry detection for prompt role injection — SYNCHRONIZED COPY of
 * core/src/jd/industry.ts. Keep in sync when the source changes (both sides
 * note this in their headers). Pure rule-based, deterministic, unit-testable.
 */
